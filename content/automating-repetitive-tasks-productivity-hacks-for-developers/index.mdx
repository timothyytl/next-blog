...
```html showLineNumbers {1-3,4} /science/ title="Component.jsx" caption="this file contains html code"
...
For more information about how to use the plugin and the features it includes, [read
the documentation](https://github.com/tailwindcss/typography/blob/master/README.md).
